...
import com.shatteredpixel.shatteredpixeldungeon.items.weapon.melee.ChopperAxe;
...
import com.shatteredpixel.shatteredpixeldungeon.items.weapon.melee.SapphireDagger;
import com.shatteredpixel.shatteredpixeldungeon.items.weapon.melee.Scalpel;
import com.shatteredpixel.shatteredpixeldungeon.items.weapon.melee.Scimitar;
import com.shatteredpixel.shatteredpixeldungeon.items.weapon.melee.ShortStick;
import com.shatteredpixel.shatteredpixeldungeon.items.weapon.melee.Shortsword;
import com.shatteredpixel.shatteredpixeldungeon.items.weapon.melee.Spear;
import com.shatteredpixel.shatteredpixeldungeon.items.weapon.melee.Sword;
import com.shatteredpixel.shatteredpixeldungeon.items.weapon.melee.TwoSword;
...
import com.shatteredpixel.shatteredpixeldungeon.items.weapon.missiles.SwordThrow;
...
public class Generator {
	...
	public enum Category {
		...
		static {
			...
			WEP_T2.probs = new float[]{ 5, 5, 5, 5, 4, 4 };
			
			WEP_T3.classes = new Class<?>[]{
					LongStick.class,
					SapphireDagger.class,
					Sword.class,
					TwoSword.class,
					Mace.class,
					Scimitar.class,
			...
			WEP_T5.probs = new float[]{ 4, 6, 5, 5, 4, 4, 4 };
			...
			MIS_T3.probs = new float[]{ 6, 6, 5, 4 };
